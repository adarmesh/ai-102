...
def main():
    ...
    try:
        ...
        load_dotenv()
        ai_endpoint = os.getenv('AZURE_CV_API_ENDPOINT')
        ai_key = os.getenv('AZURE_CV_API_KEY')
        ...
        if result.objects is not None:
            ...
            for detected_object in result.objects.list:
                ...
                print(" Object: '{}' (confidence: {:.2f}%) at location ({}, {}, {}, {})".format(
                    detected_object.tags[0].name,
                    detected_object.get('confidence', 0) * 100,
        ...
        if result.people is not None:
            ...
            for detected_person in result.people.list:
                ...
                print(" Person (confidence: {:.2f}%) at location ({}, {}, {}, {})".format(
